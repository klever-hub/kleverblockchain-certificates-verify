      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto mb-16">
          <div className="glass-card p-8 neon-glow animate-slide-up">
            ...
            {showHelp && (
              <div className="mb-6 p-4 bg-primary-100/50 dark:bg-primary/10 rounded-xl text-sm text-gray-700 dark:text-gray-300 animate-fade-in">
                <p className="mb-2">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    type="button"
                    onClick={handleDemo}
                    className="absolute right-2 top-1/2 -translate-y-1/2 px-3 py-1 text-xs font-medium text-primary-600 dark:text-primary hover:text-primary-700 dark:hover:text-primary-light transition-colors"
                  >
                    Try Demo
                  </button>
                </div>
        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-8">
            <div className="text-center">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-500">Certificates Verified</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-gradient">99.9%</p>
              <p className="text-xs text-gray-600 dark:text-gray-500">Uptime</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-gradient">Instant</p>
              <p className="text-xs text-gray-600 dark:text-gray-500">Verification</p>
            </div>
          </div>
        </div>
      </div>
